...
namespace Water2DSuface
{
	...
	[CustomEditor(typeof(Water2DScript))]
	public class Water2DScriptEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			SerializedProperty speed = serializedObject.FindProperty("m_Speed");
			...
			//sortinglayer
			MeshRenderer renderer = (target as Water2DScript).GetComponent<MeshRenderer>();
