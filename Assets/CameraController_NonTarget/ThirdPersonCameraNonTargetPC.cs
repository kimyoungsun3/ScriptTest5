...
namespace Decal_ParticleSystem
{
	public class ThirdPersonCameraNonTargetPC : MonoBehaviour
	{
		...
		void Start()
		{
			...
			{
				//ityEngine.PostProcessing.PostProcessingBehaviour _p = GetComponent<UnityEngine.PostProcessing.PostProcessingBehaviour> ();
				// (_p != null) {
				//		_p.enabled = false;
				//}
				enabled = false;
