...
public static class Gizmos2
{
	...
	public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true)
	{
		...
		//Radial circles
		Gizmos2.DebugCircle(start, up, color, radius, duration, depthTest);	
		Gizmos2.DebugCircle(end, -up, color, radius, duration, depthTest);
		Gizmos2.DebugCircle((start+end)*0.5f, up, color, radius, duration, depthTest);
	...
	public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true)
	{
		...
		Gizmos2.DebugCircle(position+_forward, direction, color, (_forward-(slerpedVector.normalized*dist)).magnitude, duration, depthTest);
		Gizmos2.DebugCircle(position+(_forward*0.5f), direction, color, ((_forward*0.5f)-(slerpedVector.normalized*(dist*0.5f))).magnitude, duration, depthTest);
	}
	...
	public static void DebugArrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
	{
		...
		Gizmos2.DebugCone(position+direction, -direction*0.333f, color, 15, duration, depthTest);
	}
	...
	public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1.0f){
		...
		//Radial circles
		Gizmos2.DrawCircle(start, up, color, radius);	
		Gizmos2.DrawCircle(end, -up, color, radius);
		Gizmos2.DrawCircle((start+end)*0.5f, up, color, radius);
	...
	public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45)
	{
		...
		Gizmos2.DrawCircle(position+_forward, direction, color, (_forward-(slerpedVector.normalized*dist)).magnitude);
		Gizmos2.DrawCircle(position+(_forward*0.5f), direction, color, ((_forward*0.5f)-(slerpedVector.normalized*(dist*0.5f))).magnitude);
	...
	{	
		...
		Gizmos2.DrawCone(position+direction, -direction*0.333f, color, 15);
